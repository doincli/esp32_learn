...
![image-20230619155829547](ppi.assets/image-20230619155829547.png)
...
![image-20230619160357664](ppi.assets/image-20230619160357664.png)
...
![image-20230619162719309](ppi.assets/image-20230619162719309.png)
...
由于PPI通道有32个，所以PPI的控制寄存器有32bit，每一个bit控制对应的通道开启或者关闭，PPI寄存器的基地址为0x4001F000，其它在此基础上偏移
...
![image-20230619163248400](ppi.assets/image-20230619163248400.png)

![image-20230619163255696](ppi.assets/image-20230619163255696.png)

寄存器设置某一个组的PPI通道开启关闭

![image-20230619163042296](ppi.assets/image-20230619163042296.png)

![image-20230619163053035](ppi.assets/image-20230619163053035.png)
...
![image-20230619163319992](ppi.assets/image-20230619163319992.png)
...
![image-20230619163345685](ppi.assets/image-20230619163345685.png)
...
![image-20230619163446468](ppi.assets/image-20230619163446468.png)
...
![image-20230619163717507](ppi.assets/image-20230619163717507.png)
...
![image-20230619173625635](ppi.assets/image-20230619173625635.png)U
...
![image-20230619173812293](ppi.assets/image-20230619173812293.png)
...
2. 通道组 是否只是用来同时EN或DIS组内的通道?
   ...
   每一个通道组的控制有两组寄存器来实现，第一组寄存器用来绑定相关通道，如下图：![image-20230619163248400](ppi.assets/image-20230619163248400.png)
   第二组寄存器用来实现组的开关
   ![image-20230619163042296](ppi.assets/image-20230619163042296.png)
...
2. PPI的event和task为什么都是独立的32位寄存器 ？
   ...
   32位寄存器刚好可以写入外设事件和外设任务的地址，这样当事件或者任务出现的时候，可以直接执行相关任务

   ![image-20230620113847383](ppi.assets/image-20230620113847383.png)
